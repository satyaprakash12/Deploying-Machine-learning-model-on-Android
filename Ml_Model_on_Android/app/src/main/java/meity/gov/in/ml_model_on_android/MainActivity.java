package meity.gov.in.ml_model_on_android;
...
public class MainActivity extends AppCompatActivity {
    ...
    EditText cgpa,iq,profile_score;
         Button predict;
         TextView result;
         String url = "http://172.16.82.229:5000//predict";
@Override
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                if(data.equals("1")){
                                    result.setText("you will be placed");
                                }else{
                                    result.setText("you will not be placed");
                                }
